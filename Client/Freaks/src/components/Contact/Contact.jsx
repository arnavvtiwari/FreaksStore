...
export default function Contact() {
    return (
        <div className="relative flex items-top justify-center min-h-[700px] bg-gray-800 text-white sm:items-center sm:pt-0">
                ...
                <div className="mt-8 overflow-hidden">
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <form className="p-6 flex flex-col justify-center">
                            ...
                            <button
    type="submit"
    className="md:w-32 bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-purple-800 transition ease-in-out duration-300 focus:outline-none focus:ring-4 focus:ring-purple-400"
>
    Submit
</button>
